...
{ 
    ...
    { 
        ...
        {
            return ""; //SystemSetting.SysSetting.ConnectionString;
        } 
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        public static SqlTransaction GetTransaction(SqlConnection con)
        {
            bool isOpen = (con.State & ConnectionState.Open) == ConnectionState.Open;
            if (!isOpen)
                con.Open();
        ...
        public static int ExecuteNonQuery(string commandText, Dictionary<string, object> Pars)
        {
            if (Pars == null)
                return ExecuteNonQuery(commandText);
            if (Pars.Keys.Count < 1)
                return ExecuteNonQuery(commandText);
            int i = 0;
            SqlParameter[] sqlPars = new SqlParameter[Pars.Keys.Count];
            foreach (string key in Pars.Keys)
            {
                SqlParameter par = new SqlParameter(key, Pars[key]);
                sqlPars[i] = par;
                i++;
            }
            return ExecuteNonQuery(GetConnSting(), CommandType.Text, commandText, sqlPars);            
        }
        public static int ExecuteNonQuery(SqlConnection con, string commandText)
        {
            return ExecuteNonQuery(con, CommandType.Text, commandText, null);  
        }

        public static int ExecuteNonQuery(SqlConnection con, string commandText, Dictionary<string, object> Pars)
        {
            if (Pars == null)
                return ExecuteNonQuery(con,commandText);
            if (Pars.Keys.Count < 1)
                return ExecuteNonQuery(con,commandText);
            int i = 0;
            SqlParameter[] sqlPars = new SqlParameter[Pars.Keys.Count];
            ...
            return ExecuteNonQuery(con, CommandType.Text, commandText, sqlPars);         
        }
        /// <summary> 
        ...
        public static int ExecuteNonQuery(SqlTransaction trans, string commandText, Dictionary<string, object> Pars)
        {
            if (Pars == null)
                return ExecuteNonQuery(trans, commandText);
            if (Pars.Keys.Count < 1)
                return ExecuteNonQuery(trans, commandText);
            int i = 0;
            SqlParameter[] sqlPars = new SqlParameter[Pars.Keys.Count];
            ...
            return ExecuteNonQuery(trans, CommandType.Text, commandText, sqlPars);
        }
        ...
        public static DataTable ExecuteDataset(string commandText)
        {
            DataSet ds = ExecuteDataset(GetConnSting(), CommandType.Text, commandText);
            if (ds.Tables.Count == 0)
                return new DataTable();
            else
                return ds.Tables[0];
        }
        public static DataTable ExecuteDataset(string commandText, Dictionary<string, object> Pars)
        {
            if (Pars == null)
            ...
            DataSet ds = ExecuteDataset(GetConnSting(), CommandType.Text, commandText, sqlPars);
            if (ds.Tables.Count == 0)
                return new DataTable();
            else
                return ds.Tables[0];
        ...
        public static DataTable ExecuteDataset(SqlConnection connection, string commandText, Dictionary<string, object> Pars)
        {
            if (Pars == null)
            ...
            DataSet ds = ExecuteDataset(connection, CommandType.Text, commandText, sqlPars);
            if (ds.Tables.Count == 0)
                return new DataTable();
            else
                return ds.Tables[0];
        ...
        public static DataTable ExecuteDataset(SqlConnection connection, string commandText)
        {
            DataSet ds = ExecuteDataset(connection, CommandType.Text, commandText);
            if (ds.Tables.Count == 0)
                return new DataTable();
            else
                return ds.Tables[0];
        ...
        public static DataTable ExecuteDataset(SqlTransaction transaction,string commandText)
        {
            return ExecuteDataset(transaction, commandText,null);
        }
        public static DataTable ExecuteDataset(SqlTransaction transaction, string commandText,Dictionary<string,object> Pars)
        {
            DataSet ds;
            if (Pars == null || Pars.Keys.Count < 1)
                ds = ExecuteDataset(transaction, CommandType.Text, commandText);
            else
            {
                int i = 0;
                SqlParameter[] sqlPars = new SqlParameter[Pars.Keys.Count];
                ...
                ds = ExecuteDataset(transaction, CommandType.Text, commandText, sqlPars);
            }
